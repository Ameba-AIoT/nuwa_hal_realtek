...
const s8 tx_pwr_limit_2g_fcc[4][14] = {
	{74, 74, 76, 80, 80, 80, 80, 78, 78, 76, 74, 64, 30, 127}, /*CCK*/
	{66, 70, 74, 84, 84, 84, 84, 76, 72, 68, 64, 50, 0, 127}, /*OFDM*/
	{56, 60, 68, 72, 72, 72, 72, 68, 64, 60, 56, 48, -4, 127}, /*HT_B20*/
	{127, 127, 52, 56, 60, 60, 60, 60, 54, 50, 28, 127, 127, 127}  /*HT_B40*/
};
const s8 tx_pwr_limit_5g_fcc[3][28] = {
	{64, 68, 74, 74, 74, 74, 68, 64, 66, 66, 66, 66, 66, 66, 66, 66, 66, 60, 56, 56, 74, 74, 74, 74, 74, 68, 68, 68}, /*OFDM*/
	{64, 68, 74, 74, 74, 74, 68, 62, 74, 74, 74, 74, 74, 74, 74, 74, 74, 66, 58, 58, 74, 74, 74, 74, 74, 68, 68, 68}, /*HT_B20*/
	{52, 56, 56, 52, 56, 60, 64, 64, 64, 54, 64, 64, 60, 60}  /*HT_B40*/
};
const u8 tx_shap_fcc[2][4] = {{0, 0, 0, 0}, {0, 0, 0}}; /*{2G{CCK, OFDM, HE_B20, HE_B40}, 5G{OFDM, HE_B20, HE_B40}}*/
...
const s8 tx_pwr_limit_2g_etsi[4][14] = {
	...
	{60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 127}, /*HT_B20*/
	{127, 127, 60, 60, 60, 60, 60, 60, 60, 60, 60, 127, 127, 127}  /*HT_B40*/
};
const s8 tx_pwr_limit_5g_etsi[3][28] = {
	{64, 64, 64, 64, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 127, 32, 32, 32, 32, 32, 32, 32, 127}, /*OFDM*/
	{64, 64, 64, 64, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 127, 32, 32, 32, 32, 32, 32, 32, 127}, /*HT_B20*/
	{60, 60, 56, 56, 56, 56, 56, 56, 56, 127, 32, 32, 32, 127}  /*HT_B40*/
};
...
const s8 tx_pwr_limit_5g_mkk[3][28] = {
	{60, 64, 64, 64, 64, 64, 64, 60, 60, 64, 64, 64, 64, 64, 64, 64, 64, 64, 60, 60, 127, 127, 127, 127, 127, 127, 127, 127}, /*OFDM*/
	{60, 64, 64, 64, 64, 64, 64, 60, 60, 64, 64, 64, 64, 64, 64, 64, 64, 64, 60, 60, 127, 127, 127, 127, 127, 127, 127, 127}, /*HT_B20*/
...
const s8 tx_pwr_limit_2g_ic[4][14] = {
	{64, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 60, 30, 127}, /*CCK*/
	{60, 64, 68, 68, 68, 68, 68, 68, 68, 68, 56, 48, 0, 127}, /*OFDM*/
	{56, 60, 68, 68, 68, 68, 68, 68, 68, 64, 56, 48, -4, 127}, /*HT_B20*/
	{127, 127, 52, 52, 60, 64, 64, 64, 54, 50, 28, 127, 127, 127}  /*HT_B40*/
};
const s8 tx_pwr_limit_5g_ic[3][28] = {
	{52, 52, 52, 52, 54, 54, 54, 52, 52, 56, 56, 56, 56, 127, 127, 127, 56, 56, 56, 52, 48, 52, 56, 56, 56, 127, 127, 127}, /*OFDM*/
	{52, 52, 52, 52, 54, 54, 54, 52, 52, 56, 56, 56, 56, 127, 127, 127, 56, 56, 56, 52, 48, 52, 56, 56, 56, 127, 127, 127}, /*HT_B20*/
	{48, 52, 52, 52, 52, 54, 127, 127, 54, 54, 56, 56, 127, 127}  /*HT_B40*/
};
const u8 tx_shap_ic[2][4] = {{0, 0, 0, 0}, {0, 0, 0}}; /*{2G{CCK, OFDM, HE_B20, HE_B40}, 5G{OFDM, HE_B20, HE_B40}}*/
...
const s8 tx_pwr_limit_5g_kcc[3][28] = {
	{52, 56, 56, 48, 52, 64, 64, 56, 52, 56, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 56, 56, 56, 52, 52, 127, 127, 127}, /*OFDM*/
	{56, 60, 60, 44, 56, 64, 64, 60, 60, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 56, 56, 56, 52, 52, 127, 127, 127}, /*HT_B20*/
	{56, 52, 56, 54, 56, 60, 60, 52, 52, 52, 56, 56, 127, 127}  /*HT_B40*/
};
...
const s8 tx_pwr_limit_2g_cn[4][14] = {
	...
	{60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 58, 36, 127}, /*OFDM*/
	{60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 56, 24, 127}, /*HT_B20*/
	{127, 127, 60, 60, 60, 60, 60, 60, 60, 60, 60, 127, 127, 127}  /*HT_B40*/
};
const s8 tx_pwr_limit_5g_cn[3][28] = {
	{64, 64, 64, 64, 56, 56, 56, 56, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 32, 32, 32, 32, 32, 127, 127, 127}, /*OFDM*/
	{64, 64, 64, 64, 56, 56, 56, 56, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 127, 32, 32, 32, 32, 32, 127, 127, 127}, /*HT_B20*/
	{60, 60, 56, 56, 127, 127, 127, 127, 127, 127, 32, 32, 127, 127}  /*HT_B40*/
};
const u8 tx_shap_cn[2][4] = {{0, 0, 0, 0}, {0, 0, 0}}; /*{2G{CCK, OFDM, HE_B20, HE_B40}, 5G{OFDM, HE_B20, HE_B40}}*/

const s8 tx_pwr_limit_2g_ww[4][14] = {
	{56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 30, 68}, /*CCK*/
	{60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 56, 48, 0, 127}, /*OFDM*/
	{56, 60, 60, 60, 60, 60, 60, 60, 60, 60, 56, 48, -4, 127}, /*HT_B20*/
	{127, 127, 52, 52, 60, 60, 60, 60, 54, 50, 28, 127, 127, 127}  /*HT_B40*/
};
const s8 tx_pwr_limit_5g_ww[3][28] = {
	{52, 52, 52, 48, 52, 54, 54, 52, 52, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 52, 32, 32, 32, 32, 32, 32, 32, 68}, /*OFDM*/
	{52, 52, 52, 44, 54, 54, 54, 52, 52, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 52, 32, 32, 32, 32, 32, 32, 32, 68}, /*HT_B20*/
	{48, 52, 52, 52, 52, 54, 56, 52, 52, 52, 32, 32, 32, 60}  /*HT_B40*/
};
...
const s8 array_mp_txpwr_byrate_2g[] = {
	0x48, 0x50, 0x50, 0x50,  //11M 5.5M 2M 1M is 18dbm 20dbm 20dbm 20dBm
	0x4c, 0x4c, 0x4c, 0x4c,  //18M 12M 9M 6M is 19dbm 19dbm 19dbm 19dBm
	0x44, 0x44, 0x48, 0x4c,  //54M 48M 36M 24M is 17dbm 17dbm 18dbm 19dBm
	0x48, 0x48, 0x48, 0x48,  // HT_MCS3 MCS2 MCS1 MCS0 is 18dbm 18dbm 18dbm 18dBm
	0x40, 0x40, 0x44, 0x48  // HT_MCS7 MCS6 MCS5 MCS4 is 16dbm 16dbm 17dbm 18dBm
};
u8 array_mp_txpwr_byrate_2g_array_len = sizeof(array_mp_txpwr_byrate_2g) / sizeof(s8);
const s8 array_mp_txpwr_byrate_5g[] = {
	0x40, 0x44, 0x44, 0x48,  //18M 12M 9M 6M is 16dbm 17dbm 17dbm 18dBm
	0x38, 0x38, 0x3c, 0x40,  //54M 48M 36M 24M is 14dbm 14dbm 15dbm 16dBm
	0x3c, 0x40, 0x40, 0x40,  // HT_MCS3 MCS2 MCS1 MCS0 is 15dbm 16dbm 16dbm 16dBm
	0x34, 0x34, 0x38, 0x3c  // HT_MCS7 MCS6 MCS5 MCS4 is 13dbm 13dbm 14dbm 15dBm
};
