...
const FlashLayoutInfo_TypeDef Flash_Layout[] = {
	...
	{IMG_BOOT_LP,	0x08000000, 0x08003FFF}, // LP Boot(16K)
	{IMG_BOOT_HP,	0x08004000, 0x08013FFF}, // HP Boot(64K)
	//Users should modify below according to their own memory
	{IMG_APP_OTA1,	0x08014000, 0x081F3FFF}, // Application OTA1, KM0 & KM4 IMG2 are combined
	{IMG_APP_OTA2,	0xFFFFFFFF, 0xFFFFFFFF}, // Application OTA2, KM0 & KM4 IMG2 are combined
...
void flash_init_userdef(void)
{
	...
	FLASH_InitStruct->FLASH_rd_dummy_cycle[1] = 0x04;
	FLASH_InitStruct->FLASH_rd_dummy_cycle[2] = 0x06;
