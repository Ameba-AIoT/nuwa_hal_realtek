...
void I2C_SetSlaveAddress(I2C_TypeDef *I2Cx, u16 Address)
{
	...
	u32 sar = I2Cx->IC_SAR & ~(BIT_CTRL_IC_SAR);
	...
	I2Cx->IC_SAR = (Address & BIT_CTRL_IC_SAR) | sar;
}
...
u32 I2C_MasterWrite(I2C_TypeDef *I2Cx, u8 *pBuf, u32 len)
{
	...
	for (cnt = 0; cnt < len; cnt++) {
		...
		while ((I2C_CheckFlagState(I2Cx, I2C_BIT_TFE)) == 0) {
			if (I2C_GetRawINT(I2Cx) & I2C_BIT_R_TX_ABRT) {
...
void I2C_Sleep_Cmd(I2C_TypeDef *I2Cx, u32 NewStatus)
{
	...
	if (NewStatus != DISABLE) {
		I2C_INTConfig(I2Cx, I2C_BIT_M_LP_WAKE_1 | I2C_BIT_M_LP_WAKE_2, ENABLE);

		I2Cx->IC_SLEEP |= BIT_IC_SLEEP_CLOCK_CONTROL;
	} else {
		I2C_INTConfig(I2Cx, I2C_BIT_M_LP_WAKE_1 | I2C_BIT_M_LP_WAKE_2, DISABLE);
...
void I2C_WakeUp(I2C_TypeDef *I2Cx)
{
	...
	I2C_ClearINT(I2Cx, I2C_BIT_R_LP_WAKE_2);
	I2C_ClearINT(I2Cx, I2C_BIT_R_LP_WAKE_1);
...
__weak u32 I2C_ISRHandle(I2C_IntModeCtrl *I2C_SemStruct)
{
	...
	if (intr_status & (I2C_BIT_R_TX_ABRT | I2C_BIT_R_RX_OVER | I2C_BIT_R_RX_FULL)) {
		I2C_ClearINT(I2Cx, intr_status & (I2C_BIT_R_TX_ABRT | I2C_BIT_R_RX_OVER | I2C_BIT_R_RX_FULL));
		I2C_INTConfig(I2Cx, (I2C_BIT_R_TX_ABRT | I2C_BIT_R_RX_OVER | I2C_BIT_R_RX_FULL), DISABLE);
