...
#ifndef _AMEBA_SPI_FLASH_H
#define _AMEBA_SPI_FLASH_H
...
typedef struct {
	...
	u8 FLASH_rd_dummy_cycle[3];	/*!< Specifies the read dummy cycle of different bitmode according to
								flash datasheet*/
	...
	u32 FLASH_dual_valid_cmd;		/*!< Specifies valid cmd of dual bitmode to program/read flash in auto mode */
	u32 FLASH_quad_valid_cmd;	/*!< Specifies valid cmd of quad bitmode to program/read flash in auto mode */
...
_LONG_CALL_ void FLASH_SW_CS_Control(u32 GPIO_State);
