...
static inline u32 SYSCFG_CUTVersion_U(void)
{
...
static inline u32 SYSCFG_CUTVersion(void)
{
	...
	if (0x0 == vendortmp) {
		...
		RTK_LOGI(NOTAG, "CUT VERSION ERROR!\n");
		return cuttmp;
	}
}

static inline u32 SYSCFG_ICVersion(void)
{
	u32 vendortmp = (HAL_READ32(0x48000000, 0x03F0) >> 4) & 0x3;
	...
	if (0x1 == vendortmp) {
		...
		RTK_LOGI(NOTAG, "IC VERSION ERROR!\n");
		return SYSCFG_CUTVersion();
	}
}
/** @} */
