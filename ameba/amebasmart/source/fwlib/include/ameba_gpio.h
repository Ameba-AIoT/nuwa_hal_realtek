...
/* GPIO_INT_MASK conflicts with Zephyr gpio.h interrupt-flags bitmask; skip in Zephyr builds. */
#ifndef __ZEPHYR__
...
/* The four helpers below are compiled from ameba_gpio.c (RAM), not from
 * lib_rom.a, so they do not carry the _LONG_CALL_ attribute used by ROM symbols.
 */
