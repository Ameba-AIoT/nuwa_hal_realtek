...
/**
  * @brief  Program the MIPI vo-clock / HPERI dividers off NPPLL and enable the
  *         shared HPERI root + LCDC&MIPI clock gate.
  ...
  * @retval None
  * @note   MIPI(<=66.7M), LCDC(<=NPPLL/4), LCDC : MIPI >= 3 : 1
  */
