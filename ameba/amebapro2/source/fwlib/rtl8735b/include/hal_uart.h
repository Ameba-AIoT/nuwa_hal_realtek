...
#define hal_uart_lp_sclk_select              hal_uart_lp_sclk_select_patch
 ...
 */
__STATIC_INLINE
void hal_uart_tx_fifo_low_hook(phal_uart_adapter_t puart_adapter, hal_uart_callback_t pcallback,
							   void *parg)
{
