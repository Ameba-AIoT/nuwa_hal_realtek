...
*/
typedef void (*hal_uart_callback_t)(void *arg);
/**
...
typedef struct hal_uart_adapter_s {
	...
	hal_uart_callback_t modem_status_ind;       /*!< callback function for modem status indication  */
	...
	hal_uart_callback_t tx_done_callback;           /*!< User callback function for Interrupt / DMA mode Tx complete  */
	hal_uart_callback_t rx_done_callback;           /*!< User callback function for Interrupt / DMA mode Rx complete */
	...
	hal_uart_callback_t rx_flt_timeout_callback;    /*!< callback function for RX filter timeout indication  */
	hal_uart_callback_t rx_flt_matched_callback;    /*!< callback function for RX filter matched indication  */
	...
	hal_uart_callback_t rx_idle_timeout_callback;   /*!< callback function for RX idle timeout indication  */
	...
	hal_uart_callback_t tx_fifo_low_callback;       /*!< User callback function for Interrupt mode Tx event: TX FIFO low  */
...
void hal_rtl_uart_txtd_hook(phal_uart_adapter_t puart_adapter, uart_irq_callback_t pcallback,
							uint32_t id, uint32_t event);
void hal_rtl_uart_txdone_hook(phal_uart_adapter_t puart_adapter, hal_uart_callback_t pcallback, void *parg);
void hal_rtl_uart_rxdone_hook(phal_uart_adapter_t puart_adapter, hal_uart_callback_t pcallback, void *parg);
...
void hal_rtl_uart_set_rx_filter_timeout(phal_uart_adapter_t puart_adapter, uint32_t timeout_ms,
										hal_uart_callback_t callback, void *cb_arg);
void hal_rtl_uart_rx_filter_en(phal_uart_adapter_t puart_adapter, hal_uart_callback_t callback, void *cb_arg);
...
void hal_rtl_uart_rx_idle_timeout_en(phal_uart_adapter_t puart_adapter, uint32_t timeout_us,
									 hal_uart_callback_t pcallback, void *parg);
void hal_rtl_uart_rx_idle_timeout_dis(phal_uart_adapter_t puart_adapter);
void hal_rtl_uart_tx_fifo_low_hook(phal_uart_adapter_t puart_adapter, hal_uart_callback_t pcallback,
								   void *parg);
...
typedef struct hal_uart_func_stubs_s {
	...
	void (*hal_uart_txdone_hook)(phal_uart_adapter_t puart_adapter, hal_uart_callback_t pcallback, void *parg);
	void (*hal_uart_rxdone_hook)(phal_uart_adapter_t puart_adapter, hal_uart_callback_t pcallback, void *parg);
	...
	void (*hal_uart_set_rx_filter_timeout)(phal_uart_adapter_t puart_adapter, uint32_t timeout_ms,
										   hal_uart_callback_t callback, void *cb_arg);
	void (*hal_uart_rx_filter_en)(phal_uart_adapter_t puart_adapter, hal_uart_callback_t callback, void *cb_arg);
	...
	void (*hal_uart_tx_fifo_low_hook)(phal_uart_adapter_t puart_adapter, hal_uart_callback_t pcallback, void *parg);
