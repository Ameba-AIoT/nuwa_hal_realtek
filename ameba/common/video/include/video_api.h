...
int video_get_codec_type(int video_type);
...
void video_init_test(unsigned char *buf, int size);
//////////////EXTEND THE ZEPHYR FORMAT TYPE////////////////
/**
 * H.264 encoded video stream (compressed format)
 */
...
#define VIDEO_CID_VENDOR_GET_PARAMS 		(VIDEO_CID_PRIVATE_BASE + 0x01)
//#define VIDEO_CID_VENDOR_SET_HEIGHT			(VIDEO_CID_PRIVATE_BASE + 0x02)
//#define VIDEO_CID_VENDOR_SET_WIDTH			(VIDEO_CID_PRIVATE_BASE + 0x03)
//#define VIDEO_CID_VENDOR_BITRATE			(VIDEO_CID_PRIVATE_BASE + 0x04)
#define VIDEO_CID_VENDOR_FPS				(VIDEO_CID_PRIVATE_BASE + 0x05)
#define VIDEO_CID_VENDOR_GOP				(VIDEO_CID_PRIVATE_BASE + 0x06)
#define VIDEO_CID_VENDOR_MEMORY_SIZE		(VIDEO_CID_PRIVATE_BASE + 0x07)
#define VIDEO_CID_VENDOR_BLOCK_SIZE			(VIDEO_CID_PRIVATE_BASE + 0x08)
#define VIDEO_CID_VENDOR_MAX_FRAME_SIZE		(VIDEO_CID_PRIVATE_BASE + 0x09)
#define VIDEO_CID_VENDOR_RCMODE				(VIDEO_CID_PRIVATE_BASE + 0x0A)
#define VIDEO_CID_VENDOR_SET_RCPARAM		(VIDEO_CID_PRIVATE_BASE + 0x0B)
#define VIDEO_CID_VENDOR_GET_RCPARAM		(VIDEO_CID_PRIVATE_BASE + 0x0C)
#define VIDEO_CID_VENDOR_INIT_MEM_POOL		(VIDEO_CID_PRIVATE_BASE + 0x0D)
#define VIDEO_CID_VENDOR_FORCE_IFRAME		(VIDEO_CID_PRIVATE_BASE + 0x0E)
#define VIDEO_CID_VENDOR_ISPFPS				(VIDEO_CID_PRIVATE_BASE + 0x0F)

#define VIDEO_CID_VENDOR_STREAMID		    (VIDEO_CID_PRIVATE_BASE + 0x10)
#define VIDEO_CID_VENDOR_FORMAT				(VIDEO_CID_PRIVATE_BASE + 0x11)
#define VIDEO_CID_VENDOR_BPS               	(VIDEO_CID_PRIVATE_BASE + 0x12)
#define VIDEO_CID_VENDOR_SNAPSHOT          	(VIDEO_CID_PRIVATE_BASE + 0x13)
#define VIDEO_CID_VENDOR_SNAPSHOT_CB       	(VIDEO_CID_PRIVATE_BASE + 0x14)
#define VIDEO_CID_VENDOR_YUV               	(VIDEO_CID_PRIVATE_BASE + 0x15)
#define VIDEO_CID_VENDOR_ISP_SET_RAWFMT    	(VIDEO_CID_PRIVATE_BASE + 0x16)
#define VIDEO_CID_VENDOR_PRINT_INFO        	(VIDEO_CID_PRIVATE_BASE + 0x17)
#define VIDEO_CID_VENDOR_SET_MULTI_RCCTRL	(VIDEO_CID_PRIVATE_BASE + 0x18)
#define VIDEO_CID_VENDOR_GET_MULTI_RCCTRL	(VIDEO_CID_PRIVATE_BASE + 0x19)
#define VIDEO_CID_VENDOR_SET_CAP_INTVL		(VIDEO_CID_PRIVATE_BASE + 0x1A)  //capture every n seconds

#define VIDEO_CID_VENDOR_PRE_INIT_PARM     	(VIDEO_CID_PRIVATE_BASE + 0x52)
#define VIDEO_CID_VENDOR_GET_PRE_INIT_PARM	(VIDEO_CID_PRIVATE_BASE + 0x53)
